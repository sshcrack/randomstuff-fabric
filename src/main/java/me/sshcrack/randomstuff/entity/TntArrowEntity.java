...
public class TntArrowEntity extends PersistentProjectileEntity {
    ...
    public TntArrowEntity(World world, double x, double y, double z) {
        super(RandomStuffMod.TntArrowEntityType, x, y, z, world);
    }

    public TntArrowEntity(World world, LivingEntity owner) {
        super(RandomStuffMod.TntArrowEntityType, owner, world);
        this.owner = owner;
    }
    ...
    protected void onBlockHit(BlockHitResult blockHitResult) {
        ...
        onHit(blockHitResult.getPos());
    }

    @Override
    protected void onEntityHit(EntityHitResult entityHitResult) {
        super.onEntityHit(entityHitResult);
        onHit(entityHitResult.getPos());
    }

    private void onHit(Vec3d vec) {
